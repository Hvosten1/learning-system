    ...
    "emotions": [
        {
            ...
            "sentences": {
                ...
                "russian": "Я испытываю радость от победы.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "У меня есть страх темноты.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Я испытываю гнев от его поведения.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Я испытал удивление от этой новости.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Я испытываю счастье в этот момент.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Я испытываю ревность к его успеху.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Меня наполняет гордость за свои достижения.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "У меня есть к тебе доверие.",
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Плохие новости вызвали у меня разочарование.",
    ...
    "nature": [
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "Река несет в себе проточную воду.",
    ...
    "technology": [
        ...
        },
        {
            ...
            "sentences": {
                ...
                "russian": "У меня есть клавиатура.",
        ...
        "food": [
            {
                ...
                "sentences": {
                    "tajik": "Картошка хӯроки дӯстдоштаи ман аст.",
                    "russian": "Картофель - моя любимая еда.",
                    "uzbek": "Картошка менинг севимли таомим.",
                    "kazakh": "Картоп менің сүйікті тағамым.",
                    "kyrgyz": "Картөшкө менин сүйүктүү тамагым."
                }
            },            
            {
                "word": "milk",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Моҳӣ хӯроки дӯстдоштаи ман аст.",
                    "russian": "Рыба моя любимая еда.",
                    "uzbek": "Балиқ менинг севимли таомим.",
                    "kazakh": "Балық менің сүйікті тағамым.",
                    "kyrgyz": "Балык менин сүйүктүү тамагым."
                }
            },
            {
                "word": "water",
                ...
                "sentences": {
                    "tajik": "Об - асоси ҳаёт аст.",
                    "russian": "Вода - основа жизни.",
                    "uzbek": "Сув - ҳаёт асосидир.",
                    "kazakh": "Су - өмірдің негізі.",
                    "kyrgyz": "Суу - жашоонун негизи."
                }
            },            
            {
                "word": "bread",
        ...
        "professions": [
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Корманди полис тартиботро нигоҳ медорад.",
        ...
        "household": [
            ...
            },
            {
                ...
                "sentences": {
                    ...
                    "uzbek": "Менинг жадвал катта.",
                    "kazakh": "Менің үстелім үлкен.",
                    "kyrgyz": "Менин устөл чоң."
                }
            },
            {
                "word": "bed",
                ...
                "sentences": {
                    "tajik": "Ман дар бистар худ хоб мекунам.",
                    "russian": "Кровать - мое любимое место для сна.",
                    "uzbek": "Ётоқ менинг севимли ухлаш жойим.",
                    "kazakh": "Төсек - менің сүйікті ұйықтау орным.",
                    "kyrgyz": "Төшөк - менин сүйүктүү уктоо жайым."
                }
            },            
            {
                "word": "sofa",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Чароғ дар рӯи мизе аст, ки ман дар он дарс мехонам.",
                    "russian": "Лампа стоит на столе, где я делаю уроки.",
                    "uzbek": "Чироқ менинг дарс қиладиган столимда туради.",
                    "kazakh": "Шам менің сабақ оқитын үстелімде тұр.",
                    "kyrgyz": "Чырак менин сабак даярдаган столумда турат."
                }
            },            
            {
                "word": "carpet",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Ман ғизоро дар яхдон мегузорам.",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Танӯр воситаи ман барои пухтупаз аст.",
                    "russian": "Духовка - основная часть моей кухни.",
                    "uzbek": "Печ менинг ошхонамнинг асосий қисми.",
                    "kazakh": "Пеш менің асханамның негізгі бөлігі.",
                    "kyrgyz": "Меш менин ашканамдын негизги бөлүгү."
                }
            },                                 
            {
                "word": "sink",
                ...
                "sentences": {
                    "tajik": "Ман зарфҳоро дар раковинаи мешӯям.",
                    "russian": "Раковина - место, где я мою посуду.",
                    "uzbek": "Чўкиш менинг идиш ювадиган жойим.",
                    "kazakh": "Раковина - мен ыдыстарды жуатын орын.",
                    "kyrgyz": "Чөгүү - мен идиштерди жуучу жай."
                }
            },            
            {
                "word": "toilet",
        ...
        "sports": [
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Лыжаронӣ як намуди варзиш аст.",
                    "russian": "Лыжный спорт - мое любимое занятие.",
                    "uzbek": "Чанғи спорти менинг севимли машғулотим.",
                    "kazakh": "Шаңғы тебу - менің сүйікті ісім.",
                    "kyrgyz": "Шаңгы тебүү - менин сүйүктүү ишим."
                }
            },            
            {
                "word": "golf",
        ...
        "transport": [
            {
                ...
                "sentences": {
                    "tajik": "Мошин ман дӯстдошта аст.",
                    "russian": "Машина - мое любимое средство передвижения.",
                    "uzbek": "Машина менинг севимли транспорт воситам.",
                    "kazakh": "Машина - менің сүйікті көлігім.",
                    "kyrgyz": "Машина - менин сүйүктүү унаам."
                }
            },            
            {
                "word": "bus",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Ман бо поезд сафар мекунам.",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Лодка воситаи олие барои гузаштан аз дарё аст.",
                    "russian": "Лодка - прекрасное средство для переправы через реку.",
                    "uzbek": "Лодка дарёни кесиб ўтиш учун ажойиб восита.",
                    "kazakh": "Лодка - өзенді кесіп өту үшін тамаша құрал.",
                    "kyrgyz": "Лодка - дарыяны кесип өтүү үчүн сонун каражат."
                }
            },            
            {
                "word": "subway",
        ...
        "school": [
            {
                ...
                "sentences": {
                    "tajik": "Китоб дониш мебахшад.",
                    "russian": "Книга несет знания.",
                    "uzbek": "Китоб билим олиб келади.",
                    "kazakh": "Кітап білім береді.",
                    "kyrgyz": "Китеп билим берет."
                }
            },            
            {
                "word": "pen",
                ...
                "sentences": {
                    "tajik": "Қалам бо ранги кабуд менависад.",
                    "russian": "Ручка пишет синим цветом.",
                    "uzbek": "Қалам кўк рангда ёзади.",
                    "kazakh": "Қалам көк түспен жазады.",
                    "kyrgyz": "Калем көк түстө жазат."
                }
            },            
            {
                "word": "teacher",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Дафтари бо кори хонагӣ аст.",
                    "russian": "Тетрадь с домашним заданием.",
                    "uzbek": "Дафтар уйга вазифалар билан.",
                    "kazakh": "Дәптер үй тапсырмасымен.",
                    "kyrgyz": "Дептер үй тапшырмасы менен."
                }
            },            
            {
                "word": "desk",
                ...
                "sentences": {
                    "tajik": "Ман дар назди парта нишастаам.",
                    "russian": "Парта - мое место для учебы.",
                    "uzbek": "Парта менинг ўқиш жойим.",
                    "kazakh": "Парта - менің оқу орным.",
                    "kyrgyz": "Парта - менин окуу ордум."
                }
            },            
            {
                "word": "blackboard",
                ...
                "sentences": {
                    "tajik": "Тахтаи синф дар ҳар синф ҳаст.",
                    "russian": "Доска есть в каждом классе.",
                    "uzbek": "Доска ҳар бир синфда бор.",
                    "kazakh": "Тақта әр сыныпта бар.",
                    "kyrgyz": "Доска ар бир класста бар."
                }
            },            
            {
                "word": "lesson",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Ман вазифаи хонагӣ худро иҷро мекунам.",
            ...
            },
            {
                ...
                "sentences": {
                    "tajik": "Китобхона макониест, ки дар он китобҳои бисёр нигоҳ дошта мешаванд.",
                    "russian": "Библиотека - место где хранится много книг.",
                    "uzbek": "Китобхона - кўп китоб сақланадиган жой.",
                    "kazakh": "Кітапхана - көптеген кітаптар сақталатын орын.",
                    "kyrgyz": "Китепкана - көп китеп сакталган жер."
                }
            },            
            {
                "word": "map",
                ...
                "sentences": {
                    "tajik": "Харита ба ман кӯмак мекунад.",
                    "russian": "Карта помогает ориентироваться.",
                    "uzbek": "Харита йўлни топишга ёрдам беради.",
                    "kazakh": "Карта бағыт табуға көмектеседі.",
                    "kyrgyz": "Карта багытты табууга жардам берет."
                }
            },            
            {
                "word": "science",
                ...
                "sentences": {
                    "tajik": "Илм қонунҳои табиатро меомӯзад.",
                    "russian": "Наука изучает законы природы.",
                    "uzbek": "Илм табиат қонунларини ўрганади.",
                    "kazakh": "Ғылым табиғат заңдарын зерттейді.",
                    "kyrgyz": "Илим табияттын мыйзамдарын изилдейт."
                }
            }
